...
// debug config
typedef int bool;
#define DEBUG_TOUCH_PANEL1

#ifdef DEBUG_TOUCH_PANEL
    #define DEBUG_OUT(x) DEBUG(x)
#else
    #define DEBUG_OUT(x)
#endif
...
#define ACTIVE_DELAY_TIME   (alt_ticks_per_second()/5)
#define SAMPLE_RATE         30  // times per seconds
#define FIFO_SIZE           2    //was 2
