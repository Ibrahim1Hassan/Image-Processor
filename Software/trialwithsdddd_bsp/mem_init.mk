...
# Memory: descriptor_mem
MEM_1 := nios_simple_descriptor_mem
$(MEM_1)_NAME := descriptor_mem
...
$(MEM_1)_START := 0x0a400000
$(MEM_1)_END := 0x0a40ffff
$(MEM_1)_HIERARCHICAL_PATH := descriptor_mem
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: descriptor_mem
descriptor_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
